...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <p class="greeting">Hi <?php echo e($contact->name); ?>,</p>
            ...
            <div class="reply-box"><?php echo e($contact->reply); ?></div>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Hawi. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\bego\Herd\hawi-backend\resources\views/emails/contact-reply.blade.php ENDPATH**/ ?>